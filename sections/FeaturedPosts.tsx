...
import { FeaturedPost } from '../components/types/post'
...
const FeaturedPosts: React.FC = () => {
  ...
  const ArrowRight = () => (
    <div className="flex justify-center absolute arrow-btn right-0 text-center py-3 cursor-pointer bg-pink-600 rounded-full">
      <svg
        xmlns="http://www.w3.org/2000/svg"
